...
# If $DisableMiners is empty, all available mining programs are used.  Any listed here will be disabled.  If there are miners that crash your system, list them here so they won't be used.
$DisableMiners = @()
