...
while ($true) {
    ...
    time1 "compare new pools with all pools"
    ...
    time1 "start selecting best pools"
    ...
    $API.Pools = $Pools
    time1 "finish selecting best pools"
    ...
    time1 "get-childitemcontent miners"
    ...
    time1 "get-childitemcontentparallel miners" $AllMiners.Count
    $AllMiners = if (Test-Path "Miners") {
    ...
    time1 "miner profit calculation phase 1"
    $AllMiners | ForEach-Object {
        ...
        time2 "processed miner" $_.Name
    }
    time1 "remove miners missing files"
    ...
    time1 "apply watchdog to miners"
    ...
    time1 "set defaults for active miners"
    ...
    time1 "set miner types for device_auto"
    ...
    time1 "dont penalize active miners"
    ...
    time1 "start profit calculations"
    ...
    time1 "bestminers_combos part 2"
    ...
    time1 "bestminers_combos_comparison"
    ...
    time1 "bestminers_combos_comparison part 2"
    ...
    time1 "bestminers_combo_comparison"
    ...
    time1 "bestminers_combo set best"
    $BestMiners_Combo | ForEach-Object {$_.Best = $true}
    time1 "bestminers_combo_comparison set best"
    $BestMiners_Combo_Comparison | ForEach-Object {$_.Best_Comparison = $true}

    time1 "start and stop miners"
    Write-Verbose "Would normally stop/start miners here"
    if ($Downloader) {$Downloader | Receive-Job}
