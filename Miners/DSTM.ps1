...
$MinerBinaryHash = "39209c0077e1fc42a5f511ac9e81817073a8d4623ebfc57fbec3308f96457316" # If newer MinerFileVersion and hash does not math MPM will trigger an automatick binary update (if Uri is present)
