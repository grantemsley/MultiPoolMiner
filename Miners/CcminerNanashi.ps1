...
$MinerBinaryHash = "1974bab01a30826497a76b79e227f3eb1c9eb9ffa6756c801fcd630122bdb5c7" # If newer MinerFileVersion and hash does not math MPM will trigger an automatick binary update (if Uri is present)
