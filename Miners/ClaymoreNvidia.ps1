...
$Type = "NVIDIA"
if (-not $Devices.$Type) {return} # No NVIDIA present in system
...
if ($Info -or -not $Config.Miners.$Name.MinerFileVersion) {
    ...
    $DefaultMinerConfig = [PSCustomObject]@{
        ...
        IgnoreHWModel    = @()
        IgnoreDeviceID   = @()
        CommonCommands   = @(" -eres 0 -logsmaxsize 1", "") # array, first value for main algo, second value for secondary algo
        ...
        DoNotMine        = [Management.Automation.PSObject]@{
...
#        $TempConfig.Miners.$Name.Commands | Add-Member "ethash;pascal:40" "" -ErrorAction SilentlyContinue
#        $TempConfig.Miners.$Name.Commands | Add-Member "ethash;pascal:60" "" -ErrorAction SilentlyContinue
#        $TempConfig.Miners.$Name.Commands | Add-Member "ethash;pascal:80" "" -ErrorAction SilentlyContinue
#        $TempConfig.Miners.$Name.Commands | Add-Member "ethash2gb;pascal:40" "" -ErrorAction SilentlyContinue
#        $TempConfig.Miners.$Name.Commands | Add-Member "ethash2gb;pascal:60" "" -ErrorAction SilentlyContinue
#        $TempConfig.Miners.$Name.Commands | Add-Member "ethash2gb;pascal:80" "" -ErrorAction SilentlyContinue
