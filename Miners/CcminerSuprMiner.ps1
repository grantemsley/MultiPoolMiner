    ...
    return [PSCustomObject]@{
        ...
        Settings          = @(
            ...
            [PSCustomObject]@{
                ...
                Description = "Optional filter parameter per algorithm and pool. MPM will not use the miner for this algorithm at the listed pool.`nSyntax: 'Algorithm_Norm = @(`"Poolname`", `"PoolnameCoins`")'. "
