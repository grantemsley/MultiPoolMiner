...
if ($MinerFileVersion -gt $Config.Miners.$Name.MinerFileVersion) {
    ...
    $DefaultMinerConfig = [PSCustomObject]@{
        ...
        "Uri" = "https://github.com/djm34/ccminer-msvc2015/releases/download/v0.3.0/ccminer.rar" # if new MinerFileVersion and new Uri MPM will download and update new binaries
        "UriManual" = ""    
        "WebLink" = "https://github.com/djm34/ccminer-msvc2015" # See here for more information about the miner
