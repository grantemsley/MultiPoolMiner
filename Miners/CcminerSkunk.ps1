...
if ($MinerFileVersion -gt $Config.Miners.$Name.MinerFileVersion) {
    ...
    $DefaultMinerConfig = [PSCustomObject]@{
        ...
        "Uri" = "https://github.com/scaras/ccminer-2.2-mod-r1/releases/download/2.2-r1/2.2-mod-r1.zip" # if new MinerFileVersion and new Uri MPM will download and update new binaries
        "ManualUri" = ""    
