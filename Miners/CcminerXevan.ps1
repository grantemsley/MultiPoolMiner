...
$MinerInfo = "Ccminer forked from krnlx/ccminer-xevan, compiled by Nemosminer (x86)"
$HashSHA256 = "e71488c61263c080964596b72880f04ac20e91a00cb6a217bce7863685705243" # If newer MinerFileVersion and hash does not math MPM will trigger an automatick binary update (if URI is present)
...
if ($Config.InfoOnly -or -not $Config.Miners.$Name.MinerFileVersion) {
    ...
    $DefaultMinerConfig = [PSCustomObject]@{
        ...
        DoNotMine        = [PSCustomObject]@{
            # Syntax: "Algorithm_Norm as in algorithm.txt" = "Poolname", e.g. "Xevan" = @("Zpool", "ZpoolCoins")
        }
    }
