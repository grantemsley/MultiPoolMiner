...
$HashSHA256 = "cd8602a080728894570c9d29fc1423fb62af1fa9caf3913e609ba21777284dee" # If newer MinerFileVersion and hash does not math MPM will trigger an automatick binary update (if Uri is present)
