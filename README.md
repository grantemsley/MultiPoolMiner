...
README.md is based on README.txt - updated on 29/04/2018 - v1.24.03 - latest version can be found here: https://github.com/MultiPoolMiner/MultiPoolMiner/blob/master/README.txt
...
#### To disable mining some currencies on a pool

Most pools ending in ...Coins allow mining selected currencies only, e.g do not mine 'AUR' & 'ARG' currencies on ZpoolCoins pool
Note: Not all pools support this, for more information consult the pools web page
...
To limit mining to well defined currencies add a line like "ExcludeCurrency": ["Excluded_Currency", "Another_Excluded_Currency", "Yet_Another_Excluded_Currency", "..."]

E.g. if you do not want to mine the currencies 'ARG' and 'AUR' on ZpoolCoins change the pool config to:

    "ZpoolCoins": {
        "Worker": "$WorkerName",
        "BTC": "$Wallet",
        "ExcludeCurrency": ["ARG", "AUR"]
    }

To allow mining all currencies remove the line "ExcludeCurrency": [...]

#### To mine only selected currencies on a pool

Most pools ending in ...Coins allow mining selected currencies only, e.g mine only 'AUR' & 'ARG' currency on ZpoolCoins pool
Note: Not all pools support this, for more information consult the pools web page
...
To limit mining to well defined currencies add a line like "Currency": ["Currency", "Another_Currency", "Yet_Another_Currency" ,"..."]

E.g. to mine only the currencies 'ARG' and 'AUR' on ZpoolCoins change the pool config to:
...
To allow mining all currencies remove the line "Currency": [...]

#### To disable mining some coins on a pool

Most pools ending in ...Coins allow mining selected coins only, e.g do not mine 'Pizza' and 'Vivo' on ZpoolCoins pool
Note: Not all pools support this, for more information consult the pools web page
